 ...
 */
public class SMPausableExecutor extends ThreadPoolExecutor {

    private boolean isPaused = true;  //false;
    private Lock pauseLock = new ReentrantLock();
    private Condition unpaused = pauseLock.newCondition();
    public SMPausableExecutor() {
    ...
    /**
     * Getter for the state of the PausableExecutor regarding whether it is paused or playing.
     * @return True if the PausableExecutor is paused. False if the PausableExecutor is playing.
     */
